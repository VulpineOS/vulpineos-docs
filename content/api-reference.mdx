...
| `GET` | `/v1/audio/captures` | Yes | List recent browser audio capture sessions, including completed captures with retained artifacts |
...
| `GET` | `/v1/audio/captures/{id}/content` | Yes | Download the retained raw audio artifact for a completed capture |
