...
| Async tasks | `GET /v1/tasks/{id}`, `POST /v1/tasks/{id}/cancel`, `GET /v1/extractions`, `GET /v1/extractions/{id}/artifacts/screenshot` | Available in the API service |
