---
title: "Foxbridge CLI Reference — Command Line Options"
description: "Foxbridge CLI flags: --binary, --port, --backend, --headless, --bidi-port, --bidi-url."
---
...
| `--binary` | auto-detect | Path to Firefox, Vulpine, or legacy Camoufox binary |
...
- [Getting Started](/getting-started) — install and launch your first VulpineOS agent
