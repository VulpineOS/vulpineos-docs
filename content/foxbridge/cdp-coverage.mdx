---
title: "Foxbridge CDP Coverage — 13 Chrome DevTools Domains for Firefox"
description: "CDP domains translated by foxbridge: Target, Page, Runtime, Input, Network, Emulation, DOM, Fetch, Performance, Accessibility, IO, Console, Browser."
---
...
- [Foxbridge Event Translation](/foxbridge/event-translation) — Juggler to CDP event mapping
- [Foxbridge BiDi Backend](/foxbridge/bidi-backend) — WebDriver BiDi support
