...
VulpineOS is a fork of [Camoufox](https://github.com/daijro/camoufox), itself based on Firefox 146.0.1. The build system uses Make targets that orchestrate Firefox's `mach` build tool.
