...
- Public docs may describe public extension interfaces, but must not include private source, private patch contents, credentials, local private paths, unreleased product plans, or operational details.
...
- Vulpine API is positioned as a hosted extraction surface without exposing private implementation detail.
- Credential, audio, and mobile provider integrations are described as extension seams with graceful unavailable behavior in public builds.
- Vulpine Mark, Android MobileBridge, Foxbridge, and VulpineOS are described as open-source surfaces.
- Unreleased products and private roadmap detail are absent from public docs.
