---
title: "Injection-Proof Accessibility Filter — Prevent AI Prompt Injection"
description: "VulpineOS strips hidden DOM nodes (display:none, opacity:0, off-screen, clip-path) from the accessibility tree to prevent prompt injection in AI browser agents."
---
